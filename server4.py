from flask import Flask, jsonify, send_file, request, Response, send_from_directory, session
...
@app.route('/loadTile/<selectedDoctor>/<slideNo>')
def loadTile(selectedDoctor, slideNo):
...
def get_box_list(Doctor, tileSlide):
    ...
    # dir = os.path.join(current_dir ,'static', 'tiles', 'Doctors', Doctor, Patient, tileName)
        ...
        x1, y1, x2, y2 = 0, 0, 0, 0
        box_list = []
        X_Reference, Y_Reference = get_referance(Doctor, tileSlide)
